...
export default function HeroSection() {
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark pt-28 pb-20 sm:pt-32 md:pt-36 md:pb-24"
    >
      {/* Background layers */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Main title */}
        <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tight leading-none mb-5 animate-fade-in-up">
        ...
        <div className="max-w-4xl mx-auto mb-12 md:mb-14 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-slate-400 mt-5 text-base md:text-xl leading-relaxed max-w-3xl mx-auto">
            Tecnología, habilidad y competencia al servicio del deporte argentino.
            Construimos una red federal para jugadores, instituciones, ligas y comunidades que quieren crecer con reglas, visibilidad y proyección.
          </p>
        </div>
        ...
        <div
          className="mt-10 flex flex-wrap items-center justify-center gap-3 text-left animate-fade-in-up"
          style={{ animationDelay: '0.4s' }}
        >
          {[
            'Competencias con alcance federal',
            'Ligas para cada perfil de jugador',
            'Comunidad y desarrollo institucional',
          ].map((item) => (
            <span
              key={item}
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 hidden -translate-x-1/2 md:flex flex-col items-center gap-2 animate-bounce">
